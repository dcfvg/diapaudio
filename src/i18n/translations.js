export const translations = {
  en: {
    ...
    pause: "Pause",
    speed: "Speed",
    delayControl: "Audio/photo offset",
    delayMs: "ms",
    ...
    timelineSettingsExportZip: "Download media (ZIP)",
  ...
  fr: {
    ...
    pause: "Pause",
    speed: "Vitesse",
    delayControl: "Décalage audio/photos",
    delayMs: "ms",
    ...
    timelineSettingsExportZip: "Télécharger les médias (ZIP)",
    timelineSettingsPremiereRelinkHint:
  ...
  es: {
    ...
    pause: "Pausa",
    speed: "Velocidad",
    delayControl: "Desfase audio/fotos",
    delayMs: "ms",
    ...
    timelineSettingsExportZip: "Descargar medios (ZIP)",
    timelineSettingsPremiereRelinkHint:
